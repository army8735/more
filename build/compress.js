var Clean=function(){var _0=require('clean-css');return _0.hasOwnProperty("Clean")?_0.Clean:_0.hasOwnProperty("default")?_0.default:_0}();
...
var tempValue;
  ...
  Compress.prototype.rbMedia = function(node) {
    var self = this;
  ...
  Compress.prototype.joinQs = function(node, pre) {
    var self = this;
    if(node.isToken()) {
      var token = node.token();
      if(!token.isVirtual()) {
